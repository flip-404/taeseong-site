    ...
    <Container>
      ...
      <CustomTable>
        ...
        <RowWrapper>
          <T_Key>Blog</T_Key>
          <T_Value>
            <a href="https://taeseong-site.vercel.app/" target="_blank" rel="noopener noreferrer">
      ...
      <IntroductionDescription>
        <div>
          ...
          <ul>
            ...
            <li>
              개발자라는 직무를 넘어, <strong>믿을 수 있는 동료이자 팀원</strong>이 되기 위해
              노력합니다.
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            <li>
              제품은 <strong>저와 팀의 가치를 증명하는 결과물</strong>입니다. 직접 만든 서비스에
              책임감을 갖고, 더 나은 결과를 위해 끝까지 파고드는 성향을 가지고 있습니다.
            </li>
            <li>
              프로젝트의 요구사항에 맞춰 <strong>최적의 기술 스택</strong>을 선택하며, 새로운 기술을
              학습하는 것을 두려워하지 않습니다.
            </li>
            <li>
              <strong>성능 최적화에 깊은 관심</strong>을 가지고 있으며, 이를 위해 다양한 접근법을
              실험하고 개선해 나갑니다.
            </li>
          </ul>
        </div>
