...
const RGNews = () => {
  return (
    <ProjectContainer>
      ...
      <Description>
        개인 맞춤형 뉴스 서비스로, 사용자의 관심사에 맞춘 뉴스를 제공하는 서비스입니다. 사용자의
        검색 기록, 읽은 기사, 선호하는 주제 등을 분석하여 최적화된 뉴스 콘텐츠를 추천하며,
        실시간으로 업데이트되는 최신 뉴스를 제공합니다
      </Description>
      <TechStack>
      ...
      <MyRole>
        ...
        <ul>
          <li>
            숏 뉴스 컴포넌트의 스와이프 전환 시 부자연스러운 화면 전환 발생{' '}
        ...
        <Subtitle>
          사용자 경험 전반에 필요한 핵심 기능을 설계하고, 성능과 접근성을 함께 고려했습니다.
        </Subtitle>
        <ul>
          <li>
            종합 검색 페이지 구현 및 렌더링·서버 호출 최적화
            <ExternalLink href="/detail/RGNews/detail_2">
              <Icons.Link />
            </ExternalLink>
          </li>
          <li>
            뉴스 검색 무한 스크롤 구현 및 에러 바운더리로 재시도 처리
            <ExternalLink href="/detail/RGNews/detail_3">
              <Icons.Link />
            </ExternalLink>
          </li>
          <li>
            관심 뉴스/언론사 저장 및 드래그 앤 드롭 UI 구현
            <ExternalLink href="/detail/RGNews/detail_4">
              <Icons.Link />
            </ExternalLink>
          </li>
          <li>
            Web Audio API 기반 TTS(음성 변환) 구현
            <ExternalLink href="/detail/RGNews/detail_5">
              <Icons.Link />
            </ExternalLink>
          </li>
        </ul>
