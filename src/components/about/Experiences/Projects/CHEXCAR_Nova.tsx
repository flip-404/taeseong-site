    ...
    <ProjectContainer>
      ...
      <Description>
        ...
        <ul>
          ...
          <li>
            프로젝트 초기 세팅을 담당하여 개발 환경을 구축하고, commitlint와 husky를 적용해 일관된 커밋 규칙을 설정했습니다.
          </li>
          <li>라우팅 구조와 상태 관리 전략을 포함한 전반적인 프론트엔드 아키텍처를 설계했습니다. 또한 RBAC 방식을 통해 사용자 권한에 따라 페이지 접근을 제어하는 권한 관리 기능을 구현하여, 보안성과 사용성을 동시에 강화했습니다. &nbsp;
